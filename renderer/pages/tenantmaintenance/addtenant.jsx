...
//     tempErrors.line_id = tenantData.contacts.line_id ? "" : "Contact Line ID is required.";
...
//     // if (!tenantImage || !nationalCardImage) {
//     //   setErrorSnackbarMessage("Please Add Pictures!");
//     //   setErrorSnackbarOpen(true);
//     //   return;
//     // }
...
export default function addtenant() {
  ...
  const handleSubmit = (event) => {
    ...
    // console.log("Before Tenant Image", tenantImage);
    // console.log("Before National Image", nationalCardImage);
    const isValid = validateForm();
    ...
    // console.log("National Image", nationalCardImage);
          ...
          <CardContent>
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DatePicker
                ...
                value={startDate}
                onChange={(newValue) => setStartDate(newValue)}
                renderInput={(params) => <TextField {...params} error={!startDate} helperText={!startDate ? "Issue Date is required" : ""} />}
                // Removed the minDate prop to allow selection of past dates
              />

              <DatePicker sx={{ width: 270, marginBottom: 1.5, marginRight: 0.5 }} label="Expiration Date" value={endDate} onChange={(newValue) => setEndDate(newValue)} renderInput={(params) => <TextField {...params} error={!endDate} helperText={!endDate ? "Expiration Date is required" : ""} />} minDate={startDate ? dayjs(startDate).add(1, "day") : undefined} />
            </LocalizationProvider>
