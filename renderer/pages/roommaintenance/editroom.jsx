...
import { Card, CardContent, Typography, TextField, Box, Button, Checkbox, FormControlLabel, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, InputLabel, Select, MenuItem, Snackbar, DialogContentText, Autocomplete, Grid } from "@mui/material";
        ...
        <Box>
          <Card sx={{ width: "55vw", marginBottom: "10px", padding: "10px" }}>
            <CardContent>
              ...
              >
                <TextField disabled={!editable} label="Room Type" name="room_type" sx={{ width: "50%", marginRight: "10px" }} fullWidth value={formData.room_type} onChange={handleInputChange} required error={!!errors.room_type} helperText={errors.room_type} />
