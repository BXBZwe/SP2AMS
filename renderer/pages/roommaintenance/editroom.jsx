...
export default function EditRoom() {
  ...
  const filteredRates = remainingRates.filter((rate) =>
    rate.item_name.toLowerCase().includes(searchTerm.toLowerCase())
  );

  const filteredAddedRates = formData.rates.filter((rate) =>
    rate.item_name.toLowerCase().includes(searchTermAdded.toLowerCase())
  );
