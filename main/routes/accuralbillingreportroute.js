...
import express from 'express';
import { fetchAccrualReport, generatePeriodicReportExcel } from '../controllers/accuralbillingreportcontroller';
...
accuralroute.get('/generateaccuralbillingreportexcel/:year', generatePeriodicReportExcel);
