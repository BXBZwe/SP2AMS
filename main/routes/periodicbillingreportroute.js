...
import express from 'express';
import { fetchBillingReport, generatePeriodicReportExcel } from '../controllers/periodicbillingreportcontroller';
...
billingReportRoute.get('/generate-periodic-report-excel/:from/:to', generatePeriodicReportExcel);
